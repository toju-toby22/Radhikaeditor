...
const Financeblogsedit = db.collection('Financeblogs');
...
const FinanceArticles = () => {
    ...
    useEffect(() => {
        const unsubscribe = Financeblogsedit.limit(100).onSnapshot(querySnapshot => {
    ...
    const DeleteBlog = (id) => {
        Financeblogsedit.doc(id).delete().then(() => {
    ...
    return (
        <div className='container'>
            ...
            <div>
                ...
                <h1>
                    Finance & Real Estate Article Editor
                </h1>
            </div>
                ...
                <table className='table'>
                    ...
                    {blogs.map(blog => (
                        ...
                        <tbody key={blog.id}>
                            <tr>
                                {/* <td></td> */}
                                <Link className="Link" to={"/Financeblogpage/" + blog.id}>
                                    <td>{blog.Title}</td>
                                {/* <td>{blog.Desc}</td> */}
                                ...
                                <td>
                                    <span className='actions'>
                                        <Link className="Link" to={"/Financeedit/" + blog.id}> <BsPencilFill /></Link>
                                    </span>
                                </td>
                                <td>
                                    <span className='actions'>
